...
> [!WARNING]
> この fork は、実機テスト中の非公式 macOS 実験版です。安定版の `.app` / `.dmg` はまだありません。現在の macOS セットアップと開発手順は[中国語 README](README.md)を参照してください。Windows ユーザーは[オリジナルの OK-WW](https://github.com/ok-oldking/ok-wuthering-waves)を使用してください。
